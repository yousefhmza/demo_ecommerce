...
class CartItem3 extends GetWidget<CartController> {
  final CartProduct product;

  const CartItem3(this.product, {super.key});
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const ShapeDecoration(color: AppColors.gray200, shape: StadiumBorder()),
                      child: Row(
                        children: [
                          InkWell(
                            onTap: () =>
                          ...
                          InkWell(
                            ...
                            child: const CustomImage(image: AppImages.imgIconPlus),
                          ),
                        ],
                      ),
                    ),
