...
class ProductImagesSlider6 extends StatefulWidget {
  final List<String> images;

  const ProductImagesSlider6({required this.images, super.key});

  @override
  State<ProductImagesSlider6> createState() => _ProductImagesSlider6State();
}

class _ProductImagesSlider6State extends State<ProductImagesSlider6> {
